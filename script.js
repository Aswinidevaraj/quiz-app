...
const quiz = [
    {
        question: "Q.Which of the following is not a Java feature?",
    ...
    {
        question: "Q. In which process, a local variable has the same name as one of the instance variables?",
